...
class TestJSONBSerialization:
    ...
    def test_jsonb_serialization_dict(self):
        ...
        record = {"raw_id": 1, "raw_payload": {"key": "value", "number": 123}}
    ...
    def test_jsonb_serialization_already_string(self):
        ...
        json_str = '{"key": "value"}'
        record = {"raw_id": 1, "raw_payload": json_str}
    ...
    def test_jsonb_serialization_none(self):
        ...
        record = {"raw_id": 1, "raw_payload": None}
    ...
    def test_jsonb_serialization_complex_payload(self):
        ...
        complex_payload = {
            ...
            "Client": "Test Company",
            "Total RUB": "195103.50",
            "nested": {"array": [1, 2, 3], "bool": True, "null": None},
        }

        record = {"raw_id": 1, "raw_payload": complex_payload}
