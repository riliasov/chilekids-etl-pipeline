...
class TestNormalizeRecord:
    ...
    def test_normalize_sample_1(self):
        ...
        record = normalize_record(
            raw_id=1,
            sheet_row_number=10,
            received_at=datetime(2023, 7, 16, 12, 0),
    ...
    def test_normalize_sample_2(self):
        ...
        record = normalize_record(
            raw_id=2,
            sheet_row_number=20,
            received_at=datetime(2023, 8, 1, 12, 0),
    ...
    def test_normalize_sample_3(self):
        ...
        record = normalize_record(
            raw_id=3,
            sheet_row_number=30,
            received_at=datetime(2023, 9, 15, 12, 0),
            payload=SAMPLE_PAYLOAD_3
        )
    ...
    def test_payload_hash_unique(self):
        ...
        record1 = normalize_record(1, 1, datetime.now(), SAMPLE_PAYLOAD_1)
        record2 = normalize_record(2, 2, datetime.now(), SAMPLE_PAYLOAD_2)
